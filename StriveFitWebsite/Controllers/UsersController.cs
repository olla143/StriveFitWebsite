...
namespace StriveFitWebsite.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Userid,Name,Email,Isactive,Balance,ImageFile")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Userid,Name,Email,Isactive,Balance,ImageFile")] User user)
        {
            if (id != user.Userid)
            {
                return NotFound();
