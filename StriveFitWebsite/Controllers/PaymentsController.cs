...
namespace StriveFitWebsite.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        {
            var modelContext = _context.Payments.Include(p => p.Subscription);
        ...
        public async Task<IActionResult> Create([Bind("Paymentid,Subscriptionid,Amount,Paymentdate,Paymentmethod,Paymentstatus")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Paymentid,Subscriptionid,Amount,Paymentdate,Paymentmethod,Paymentstatus")] Payment payment)
        {
